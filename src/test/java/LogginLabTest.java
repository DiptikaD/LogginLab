...
//                logger.log(Level.INFO, "Threshold not yet reached! It is " + i);
//                assertTrue(lab.thresholdReached(i));
//            } else {
//                logger.log(Level.WARNING, "Threshold is reached!!");
//                assertTrue(lab.thresholdReached(i));
//            }
//        }
        ...
        logger.log(Level.WARNING, "Threshold reached!! No more than " + i);
        assertTrue(lab.thresholdReached(i));
    }
}